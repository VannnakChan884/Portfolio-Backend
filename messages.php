                            ...
                            <tr id="reply-row-<?= $row['id'] ?>" class="hidden">
                                <td colspan="6" class="bg-gray-50 dark:bg-gray-800 p-2">
                                    ...
                                    <form method="post">
                                        ...
                                        <textarea id="reply-textarea-<?= $row['id'] ?>" name="reply" rows="2" class="w-full p-1 border dark:bg-gray-700"><?= htmlspecialchars($row['reply'] ?? '') ?></textarea>
                                        <button type="submit" class="mt-1 px-3 py-1 bg-green-600 text-white text-sm rounded">Save Reply</button>
                                    </form>
                                    </div>
                                </td>
                            </tr>
